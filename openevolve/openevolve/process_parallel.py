...
_worker_operator_name = None
_worker_operator_category = None
_worker_mode = None
_worker_file_name = None
_worker_test_file_path = None
...
def _worker_init(config_dict: dict, evaluation_file: str, parent_env: dict = None, 
    ...
    global _worker_operator_name, _worker_operator_category, _worker_mode, _worker_file_name, _worker_test_file_path
    ...
    _worker_operator_name = operator_name
    _worker_operator_category = operator_category
    _worker_mode = mode
    _worker_file_name = file_name
    _worker_test_file_path = test_file_path
...
def _lazy_init_worker_components():
    ...
    if _worker_evaluator is None:
        ...
        _worker_evaluator = Evaluator(
            ...
            operator_name=_worker_operator_name,
            operator_category=_worker_operator_category,
            mode=_worker_mode,
            file_name=_worker_file_name,
            test_file_path=_worker_test_file_path
        )
...
class ProcessParallelController:
    ...
    def __init__(self, config: Config, evaluation_file: str, database: ProgramDatabase, evolution_tracer=None, file_suffix: str = ".py", 
        ...
        self.operator_category = operator_category
        self.mode = mode
