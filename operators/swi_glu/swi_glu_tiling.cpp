...
public:
// [[[ REPLACE_START: GluSingleTilingCalculator::GluSingleTilingCalculator ]]]
...
// [[[ REPLACE_END ]]]
    ...
    template <GLU_FLAG Glu_Flag>
// [[[ REPLACE_START: GluSingleTilingCalculator::SetTotalShape ]]]
...
// [[[ REPLACE_END ]]]
    ...
    template <GLU_FLAG Glu_Flag, uint16_t bufferNum>
// [[[ REPLACE_START: GluSingleTilingCalculator::GetBufferNumAndDataLenPerUB ]]]
...
template <GLU_FLAG Glu_Flag, uint16_t bufferNum>
// [[[ REPLACE_START: GluSingleTilingCalculator::CalcUbMaxTileLen ]]]
...
// [[[ REPLACE_START: GluSingleTilingCalculator::getBaseColLenUpBound ]]]
...
// [[[ REPLACE_START: GluSingleTilingCalculator::getBaseRowLenUpBound ]]]
 ...
 */
// [[[ REPLACE_START: GluSingleTilingCalculator::MustBeSingleBaseRowLen ]]]
 ...
 * colLen非32B对齐时：若(colLen * 2 – baseCloLen) * sizeof(Dtype) > 65535，则baseRowLen=1
 */
// [[[ REPLACE_START: GluSingleTilingCalculator::isInvalidBaseShape ]]]
...
// [[[ REPLACE_START: GluSingleTilingCalculator::isValidTailCol ]]]
...
// [[[ REPLACE_START: GluSingleTilingCalculator::isSupportSocV ]]]
